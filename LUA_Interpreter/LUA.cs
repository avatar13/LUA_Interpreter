...
#pragma warning restore 649
    ...
    protected override void Initialize()
    {
        ...
        AddState(0, new State(-4, new int[] { -1, 1, -3, 3 }));
        AddState(1, new State(new int[] { 127, 2 }));
        AddState(2, new State(-1));
        AddState(3, new State(new int[] { 127, 4, 130, 52, 138, 73, 148, 76, 133, 122, 146, 126, 137, 139, 134, 142, 139, 143, 143, 162, 136, 182 }, new int[] { -4, 5, -7, 8, -21, 67, -13, 51, -23, 53, -9, 72 }));
        AddState(4, new State(-2));
        AddState(5, new State(new int[] { 59, 7, 127, -6, 130, -6, 138, -6, 148, -6, 133, -6, 146, -6, 137, -6, 134, -6, 139, -6, 143, -6, 136, -6, 131, -6, 147, -6, 145, -6, 142, -6 }, new int[] { -5, 6 }));
        AddState(6, new State(-3));
        AddState(7, new State(-5));
        AddState(8, new State(new int[] { 61, 9 }));
        AddState(9, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -8, 10, -25, 141, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(11, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 12, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(13, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 14, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(15, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 16, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(17, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 18, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(19, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 20, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(21, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 22, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(23, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 24, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        AddState(24, new State(-63));
        AddState(25, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 26, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(27, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 28, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(29, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 30, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(31, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 32, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(33, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 34, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(35, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 36, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(37, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 38, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(39, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 40, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(41, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 42, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(54, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -10, 55, -25, 57, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(61, new State(new int[] { 149, 170, 130, 52, 41, -24 }, new int[] { -16, 62, -19, 169, -13, 171 }));
        AddState(62, new State(new int[] { 41, 63 }));
        AddState(63, new State(-4, new int[] { -6, 64, -3, 66 }));
        AddState(64, new State(new int[] { 131, 65 }));
        AddState(65, new State(-83));
        AddState(66, new State(new int[] { 130, 52, 138, 73, 148, 76, 133, 122, 146, 126, 137, 139, 134, 142, 139, 143, 143, 162, 136, 182, 131, -7, 147, -7, 145, -7, 142, -7 }, new int[] { -4, 5, -7, 8, -21, 67, -13, 51, -23, 53, -9, 72 }));
        AddState(67, new State(new int[] { 91, -40, 46, -40, 58, -40, 40, -40, 123, -40, 128, -40, 44, -36, 61, -36 }, new int[] { -22, 68 }));
        AddState(68, new State(new int[] { 44, 69, 61, -34 }));
        AddState(69, new State(new int[] { 130, 52 }, new int[] { -21, 70, -13, 51, -23, 53, -9, 71 }));
        ...
        AddState(73, new State(-4, new int[] { -6, 74, -3, 66 }));
        AddState(74, new State(new int[] { 131, 75 }));
        AddState(75, new State(-10));
        AddState(76, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -10, 77, -25, 57, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        AddState(77, new State(new int[] { 138, 78 }));
        AddState(78, new State(-4, new int[] { -6, 79, -3, 66 }));
        AddState(79, new State(new int[] { 131, 80 }));
        AddState(80, new State(-11));
        AddState(81, new State(-54));
        AddState(82, new State(new int[] { 130, 52 }, new int[] { -13, 83 }));
        AddState(83, new State(-88));
        AddState(84, new State(-56));
        AddState(85, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108, 91, 96, 59, -95, 125, -95 }, new int[] { -33, 86, -34, 88, -36, 113, -25, 114, -26, 44, -21, 50, -13, 118, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84, -35, 119, -37, 91, -39, 92 }));
        AddState(86, new State(new int[] { 125, 87 }));
        AddState(87, new State(-89));
        AddState(88, new State(new int[] { 59, 89, 125, -90 }));
        AddState(89, new State(new int[] { 91, 96, 130, 52, 125, -97 }, new int[] { -35, 90, -37, 91, -39, 92, -13, 110 }));
        ...
        AddState(94, new State(new int[] { 91, 96, 130, 52, 59, -100, 125, -100 }, new int[] { -39, 95, -13, 110 }));
        AddState(95, new State(-104));
        AddState(96, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 97, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(99, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 100, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(101, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 102, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(104, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 105, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        AddState(105, new State(-73));
        AddState(106, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 107, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        AddState(107, new State(-74));
        AddState(108, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 109, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        AddState(109, new State(-75));
        AddState(110, new State(new int[] { 61, 111 }));
        AddState(111, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -25, 112, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(116, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108, 59, -98, 125, -98 }, new int[] { -25, 117, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(120, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108, 125, -95 }, new int[] { -34, 121, -36, 113, -25, 114, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        AddState(121, new State(-93));
        AddState(122, new State(-4, new int[] { -6, 123, -3, 66 }));
        AddState(123, new State(new int[] { 147, 124 }));
        AddState(124, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -10, 125, -25, 57, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        AddState(125, new State(-12));
        AddState(126, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -10, 127, -25, 57, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        AddState(127, new State(new int[] { 141, 128 }));
        AddState(128, new State(-4, new int[] { -6, 129, -3, 66 }));
        AddState(129, new State(-28, new int[] { -11, 130 }));
        AddState(130, new State(new int[] { 145, 133, 142, 137, 131, -30 }, new int[] { -12, 131 }));
        AddState(131, new State(new int[] { 131, 132 }));
        AddState(132, new State(-13));
        AddState(133, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -10, 134, -25, 57, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        AddState(134, new State(new int[] { 141, 135 }));
        AddState(135, new State(-4, new int[] { -6, 136, -3, 66 }));
        AddState(136, new State(-27));
        AddState(137, new State(-4, new int[] { -6, 138, -3, 66 }));
        AddState(138, new State(-29));
        AddState(139, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108, 59, -14, 127, -14, 138, -14, 148, -14, 133, -14, 146, -14, 137, -14, 134, -14, 139, -14, 136, -14, 131, -14, 147, -14, 145, -14, 142, -14 }, new int[] { -8, 140, -25, 141, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(143, new State(new int[] { 130, 52 }, new int[] { -13, 144 }));
        AddState(144, new State(new int[] { 61, 145, 44, 155 }));
        AddState(145, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -10, 146, -25, 57, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        AddState(146, new State(new int[] { 44, 147 }));
        AddState(147, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -10, 148, -25, 57, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        AddState(148, new State(new int[] { 44, 153, 138, -22 }, new int[] { -14, 149 }));
        AddState(149, new State(new int[] { 138, 150 }));
        AddState(150, new State(-4, new int[] { -6, 151, -3, 66 }));
        AddState(151, new State(new int[] { 131, 152 }));
        AddState(152, new State(-17));
        AddState(153, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -10, 154, -25, 57, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        AddState(154, new State(-21));
        AddState(155, new State(new int[] { 130, 52 }, new int[] { -13, 156 }));
        AddState(156, new State(new int[] { 132, 157 }));
        AddState(157, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -10, 158, -25, 57, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        AddState(158, new State(new int[] { 138, 159 }));
        AddState(159, new State(-4, new int[] { -6, 160, -3, 66 }));
        AddState(160, new State(new int[] { 131, 161 }));
        AddState(161, new State(-18));
        AddState(162, new State(new int[] { 130, 52 }, new int[] { -15, 163, -13, 177 }));
        AddState(163, new State(new int[] { 40, 164 }));
        AddState(164, new State(new int[] { 149, 170, 130, 52, 41, -24 }, new int[] { -16, 165, -19, 169, -13, 171 }));
        AddState(165, new State(new int[] { 41, 166 }));
        AddState(166, new State(-4, new int[] { -6, 167, -3, 66 }));
        AddState(167, new State(new int[] { 131, 168 }));
        AddState(168, new State(-19));
        AddState(169, new State(-23));
        AddState(170, new State(-84));
        AddState(171, new State(-44, new int[] { -24, 172 }));
        AddState(172, new State(new int[] { 44, 174, 41, -87 }, new int[] { -32, 173 }));
        AddState(173, new State(-85));
        AddState(174, new State(new int[] { 149, 176, 130, 52 }, new int[] { -13, 175 }));
        AddState(175, new State(-43));
        AddState(176, new State(-86));
        AddState(177, new State(new int[] { 46, 178, 58, 180, 40, -31 }));
        AddState(178, new State(new int[] { 130, 52 }, new int[] { -13, 179 }));
        AddState(179, new State(-32));
        AddState(180, new State(new int[] { 130, 52 }, new int[] { -13, 181 }));
        AddState(181, new State(-33));
        AddState(182, new State(new int[] { 130, 52 }, new int[] { -17, 183, -13, 188 }));
        AddState(183, new State(new int[] { 61, 186, 59, -26, 127, -26, 130, -26, 138, -26, 148, -26, 133, -26, 146, -26, 137, -26, 134, -26, 139, -26, 143, -26, 136, -26, 131, -26, 147, -26, 145, -26, 142, -26 }, new int[] { -18, 184, -20, 185 }));
        AddState(184, new State(-20));
        AddState(185, new State(-25));
        AddState(186, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108 }, new int[] { -8, 187, -25, 141, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        AddState(188, new State(-44, new int[] { -24, 189 }));
        ...
        AddState(190, new State(new int[] { 130, 52 }, new int[] { -13, 175 }));
        AddState(191, new State(new int[] { 130, 52 }, new int[] { -13, 192 }));
        AddState(192, new State(-39));
        AddState(193, new State(-76));
        AddState(194, new State(new int[] { 130, 52 }, new int[] { -13, 195 }));
        AddState(195, new State(new int[] { 40, 197, 123, 85, 128, 202 }, new int[] { -30, 196, -29, 201 }));
        AddState(196, new State(-77));
        AddState(197, new State(new int[] { 140, 43, 129, 48, 128, 49, 130, 52, 143, 60, 37, 82, 123, 85, 40, 101, 157, 104, 35, 106, 158, 108, 41, -82 }, new int[] { -31, 198, -8, 200, -25, 141, -26, 44, -21, 50, -13, 51, -23, 53, -9, 58, -27, 59, -28, 81, -29, 84 }));
        ...
        rules[5] = new Rule(-5, new int[] { 59 });
        rules[6] = new Rule(-5, new int[] { });
        rules[7] = new Rule(-6, new int[] { -3 });
        rules[8] = new Rule(-4, new int[] { -7, 61, -8 });
        rules[9] = new Rule(-4, new int[] { -9 });
        rules[10] = new Rule(-4, new int[] { 138, -6, 131 });
        rules[11] = new Rule(-4, new int[] { 148, -10, 138, -6, 131 });
        rules[12] = new Rule(-4, new int[] { 133, -6, 147, -10 });
        rules[13] = new Rule(-4, new int[] { 146, -10, 141, -6, -11, -12, 131 });
        rules[14] = new Rule(-4, new int[] { 137 });
        rules[15] = new Rule(-4, new int[] { 137, -8 });
        rules[16] = new Rule(-4, new int[] { 134 });
        rules[17] = new Rule(-4, new int[] { 139, -13, 61, -10, 44, -10, -14, 138, -6, 131 });
        rules[18] = new Rule(-4, new int[] { 139, -13, 44, -13, 132, -10, 138, -6, 131 });
        rules[19] = new Rule(-4, new int[] { 143, -15, 40, -16, 41, -6, 131 });
        rules[20] = new Rule(-4, new int[] { 136, -17, -18 });
        rules[21] = new Rule(-14, new int[] { 44, -10 });
        rules[22] = new Rule(-14, new int[] { });
        rules[23] = new Rule(-16, new int[] { -19 });
        rules[24] = new Rule(-16, new int[] { });
        rules[25] = new Rule(-18, new int[] { -20 });
        rules[26] = new Rule(-18, new int[] { });
        rules[27] = new Rule(-11, new int[] { -11, 145, -10, 141, -6 });
        rules[28] = new Rule(-11, new int[] { });
        rules[29] = new Rule(-12, new int[] { 142, -6 });
        rules[30] = new Rule(-12, new int[] { });
        rules[31] = new Rule(-15, new int[] { -13 });
        rules[32] = new Rule(-15, new int[] { -13, 46, -13 });
        rules[33] = new Rule(-15, new int[] { -13, 58, -13 });
        rules[34] = new Rule(-7, new int[] { -21, -22 });
        rules[35] = new Rule(-22, new int[] { -22, 44, -21 });
        rules[36] = new Rule(-22, new int[] { });
        rules[37] = new Rule(-21, new int[] { -13 });
        rules[38] = new Rule(-21, new int[] { -23, 91, -10, 93 });
        rules[39] = new Rule(-21, new int[] { -23, 46, -13 });
        rules[40] = new Rule(-23, new int[] { -21 });
        rules[41] = new Rule(-23, new int[] { -9 });
        rules[42] = new Rule(-17, new int[] { -13, -24 });
        rules[43] = new Rule(-24, new int[] { -24, 44, -13 });
        rules[44] = new Rule(-24, new int[] { });
        rules[45] = new Rule(-20, new int[] { 61, -8 });
        rules[46] = new Rule(-8, new int[] { -25 });
        rules[47] = new Rule(-8, new int[] { -8, 44, -25 });
        rules[48] = new Rule(-10, new int[] { -25 });
        rules[49] = new Rule(-25, new int[] { 140 });
        rules[50] = new Rule(-25, new int[] { -26 });
        rules[51] = new Rule(-25, new int[] { 128 });
        rules[52] = new Rule(-25, new int[] { -21 });
        rules[53] = new Rule(-25, new int[] { -27 });
        rules[54] = new Rule(-25, new int[] { -28 });
        rules[55] = new Rule(-25, new int[] { -9 });
        rules[56] = new Rule(-25, new int[] { -29 });
        rules[57] = new Rule(-25, new int[] { 40, -25, 41 });
        rules[58] = new Rule(-25, new int[] { -25, 42, -25 });
        rules[59] = new Rule(-25, new int[] { -25, 47, -25 });
        rules[60] = new Rule(-25, new int[] { -25, 37, -25 });
        rules[61] = new Rule(-25, new int[] { -25, 43, -25 });
        rules[62] = new Rule(-25, new int[] { -25, 45, -25 });
        rules[63] = new Rule(-25, new int[] { -25, 94, -25 });
        rules[64] = new Rule(-25, new int[] { -25, 154, -25 });
        rules[65] = new Rule(-25, new int[] { -25, 60, -25 });
        rules[66] = new Rule(-25, new int[] { -25, 62, -25 });
        rules[67] = new Rule(-25, new int[] { -25, 151, -25 });
        rules[68] = new Rule(-25, new int[] { -25, 150, -25 });
        rules[69] = new Rule(-25, new int[] { -25, 152, -25 });
        rules[70] = new Rule(-25, new int[] { -25, 153, -25 });
        rules[71] = new Rule(-25, new int[] { -25, 156, -25 });
        rules[72] = new Rule(-25, new int[] { -25, 155, -25 });
        rules[73] = new Rule(-25, new int[] { 157, -25 });
        rules[74] = new Rule(-25, new int[] { 35, -25 });
        rules[75] = new Rule(-25, new int[] { 158, -25 });
        rules[76] = new Rule(-9, new int[] { -23, -30 });
        rules[77] = new Rule(-9, new int[] { -23, 58, -13, -30 });
        rules[78] = new Rule(-30, new int[] { 40, -31, 41 });
        rules[79] = new Rule(-30, new int[] { -29 });
        rules[80] = new Rule(-30, new int[] { 128 });
        rules[81] = new Rule(-31, new int[] { -8 });
        rules[82] = new Rule(-31, new int[] { });
        rules[83] = new Rule(-27, new int[] { 143, 40, -16, 41, -6, 131 });
        rules[84] = new Rule(-19, new int[] { 149 });
        rules[85] = new Rule(-19, new int[] { -13, -24, -32 });
        rules[86] = new Rule(-32, new int[] { 44, 149 });
        rules[87] = new Rule(-32, new int[] { });
        rules[88] = new Rule(-28, new int[] { 37, -13 });
        ...
        rules[98] = new Rule(-36, new int[] { -25, -38, 44 });
        rules[99] = new Rule(-36, new int[] { -25, -38 });
        rules[100] = new Rule(-37, new int[] { -39, -40, 44 });
        rules[101] = new Rule(-37, new int[] { -39, -40 });
        rules[102] = new Rule(-38, new int[] { -38, 44, -25 });
        rules[103] = new Rule(-38, new int[] { });
        rules[104] = new Rule(-40, new int[] { -40, 44, -39 });
        rules[105] = new Rule(-40, new int[] { });
        rules[106] = new Rule(-39, new int[] { 91, -25, 93, 61, -25 });
        rules[107] = new Rule(-39, new int[] { -13, 61, -25 });
        rules[108] = new Rule(-13, new int[] { 130 });
        rules[109] = new Rule(-26, new int[] { -26, 129 });
        rules[110] = new Rule(-26, new int[] { -26, 46, 129 });
        rules[111] = new Rule(-26, new int[] { 129 });
        this.InitRules(rules);

        this.InitNonTerminals(new string[] {"", "PROGRAM", "$accept", "CHUNK", "STAT", 
      "COMMA", "BLOCK", "VARLIST1", "EXPLIST1", "FUNCTION_CALL", "EXP1", "ELSEIF_LIST", 
      "ELSE_LIST", "NAME", "EXPTEMP", "FUNCNAME", "PL_OPT", "DECLIST", "INIT_OPT", 
      "PARLIST1", "INIT", "VAR", "VAR_LIST", "VARORFUNC", "NAME_LIST", "EXP", 
      "NUMBER", "FUNCTION", "UPVALUE", "TABLE_CONSTRUCTOR", "ARGS", "EXP_LIST_OPT", 
...
public class Lexer : QUT.Gppg.AbstractScanner<int, LexLocation>
{
    ...
    {        
        ...
        Console.Error.WriteLine("Считанный символ: {0}", ch);
        if (ch == '\n')
        {
            m_isLineComment = false;
            //return ch;
        ...
        {
            //Console.Error.WriteLine("ПРОБЕЛ");
            return yylex();
        }
