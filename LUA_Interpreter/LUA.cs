...
#pragma warning restore 649
  ...
  protected override void Initialize()
  {
    ...
    this.InitStateTable(199);
    AddState(0,new State(-4,new int[]{-37,1,-18,3}));
    AddState(1,new State(new int[]{127,2}));
    AddState(2,new State(-1));
    AddState(3,new State(new int[]{127,4,130,52,138,73,148,76,133,118,146,122,137,135,134,138,139,139,143,158,136,178},new int[]{-6,5,-3,8,-5,67,-1,51,-21,53,-20,72}));
    AddState(4,new State(-2));
    AddState(5,new State(new int[]{59,7,127,-6,130,-6,138,-6,148,-6,133,-6,146,-6,137,-6,134,-6,139,-6,143,-6,136,-6,131,-6,147,-6,145,-6,142,-6},new int[]{-39,6}));
    AddState(6,new State(-3));
    AddState(7,new State(-5));
    AddState(8,new State(new int[]{61,9}));
    AddState(9,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-4,10,-16,137,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    ...
    AddState(11,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,12,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    ...
    AddState(13,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,14,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    ...
    AddState(15,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,16,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    ...
    AddState(17,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,18,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    ...
    AddState(19,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,20,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    ...
    AddState(21,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,22,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    ...
    AddState(23,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,24,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    AddState(24,new State(-63));
    AddState(25,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,26,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    ...
    AddState(27,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,28,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    ...
    AddState(29,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,30,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    ...
    AddState(31,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,32,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    ...
    AddState(33,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,34,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    ...
    AddState(35,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,36,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    ...
    AddState(37,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,38,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    ...
    AddState(39,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,40,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    ...
    AddState(41,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,42,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    ...
    AddState(45,new State(-107));
    AddState(46,new State(new int[]{129,47}));
    AddState(47,new State(-108));
    AddState(48,new State(-109));
    ...
    AddState(52,new State(-106));
    AddState(53,new State(new int[]{91,54,46,187,58,190,40,193,123,85,128,198},new int[]{-22,189,-28,197}));
    AddState(54,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-17,55,-16,57,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    ...
    AddState(61,new State(new int[]{149,166,130,52,41,-24},new int[]{-12,62,-13,165,-1,167}));
    ...
    AddState(66,new State(new int[]{130,52,138,73,148,76,133,118,146,122,137,135,134,138,139,139,143,158,136,178,131,-7,147,-7,145,-7,142,-7},new int[]{-6,5,-3,8,-5,67,-1,51,-21,53,-20,72}));
    ...
    AddState(76,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-17,77,-16,57,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    ...
    AddState(85,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101,91,112,125,-93},new int[]{-29,86,-30,88,-31,89,-16,90,-2,44,-5,50,-1,103,-21,53,-20,58,-24,59,-40,81,-28,84,-33,106,-34,107,-36,108}));
    AddState(86,new State(new int[]{125,87}));
    AddState(87,new State(-89));
    AddState(88,new State(-90));
    AddState(89,new State(-92));
    AddState(90,new State(new int[]{42,13,47,15,37,17,43,19,45,21,94,23,154,25,60,27,62,29,151,31,150,33,152,35,153,37,156,39,155,41,44,-101,125,-101},new int[]{-32,91}));
    AddState(91,new State(new int[]{44,92,125,-97}));
    AddState(92,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101,125,-96},new int[]{-16,93,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    AddState(93,new State(new int[]{42,13,47,15,37,17,43,19,45,21,94,23,154,25,60,27,62,29,151,31,150,33,152,35,153,37,156,39,155,41,44,-100,125,-100}));
    AddState(94,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,95,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    AddState(95,new State(new int[]{41,96,42,13,47,15,37,17,43,19,45,21,94,23,154,25,60,27,62,29,151,31,150,33,152,35,153,37,156,39,155,41}));
    AddState(96,new State(-57));
    AddState(97,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,98,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    AddState(98,new State(-73));
    AddState(99,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,100,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    AddState(100,new State(-74));
    AddState(101,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,102,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    AddState(102,new State(-75));
    AddState(103,new State(new int[]{61,104,42,-37,47,-37,37,-37,43,-37,45,-37,94,-37,154,-37,60,-37,62,-37,151,-37,150,-37,152,-37,153,-37,156,-37,155,-37,44,-37,125,-37,91,-37,46,-37,58,-37,40,-37,123,-37,128,-37}));
    AddState(104,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,105,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    AddState(105,new State(new int[]{42,13,47,15,37,17,43,19,45,21,94,23,154,25,60,27,62,29,151,31,150,33,152,35,153,37,156,39,155,41,44,-105,125,-105}));
    AddState(106,new State(-91));
    AddState(107,new State(-94));
    AddState(108,new State(-103,new int[]{-35,109}));
    AddState(109,new State(new int[]{44,110,125,-99}));
    AddState(110,new State(new int[]{91,112,130,52,125,-98},new int[]{-36,111,-1,117}));
    AddState(111,new State(-102));
    AddState(112,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,113,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    AddState(113,new State(new int[]{93,114,42,13,47,15,37,17,43,19,45,21,94,23,154,25,60,27,62,29,151,31,150,33,152,35,153,37,156,39,155,41}));
    AddState(114,new State(new int[]{61,115}));
    AddState(115,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-16,116,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    AddState(116,new State(new int[]{42,13,47,15,37,17,43,19,45,21,94,23,154,25,60,27,62,29,151,31,150,33,152,35,153,37,156,39,155,41,44,-104,125,-104}));
    AddState(117,new State(new int[]{61,104}));
    AddState(118,new State(-4,new int[]{-19,119,-18,66}));
    AddState(119,new State(new int[]{147,120}));
    AddState(120,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-17,121,-16,57,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    AddState(121,new State(-12));
    AddState(122,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-17,123,-16,57,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    AddState(123,new State(new int[]{141,124}));
    AddState(124,new State(-4,new int[]{-19,125,-18,66}));
    AddState(125,new State(-28,new int[]{-26,126}));
    AddState(126,new State(new int[]{145,129,142,133,131,-30},new int[]{-27,127}));
    AddState(127,new State(new int[]{131,128}));
    AddState(128,new State(-13));
    AddState(129,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-17,130,-16,57,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    AddState(130,new State(new int[]{141,131}));
    AddState(131,new State(-4,new int[]{-19,132,-18,66}));
    AddState(132,new State(-27));
    AddState(133,new State(-4,new int[]{-19,134,-18,66}));
    AddState(134,new State(-29));
    AddState(135,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101,59,-14,127,-14,138,-14,148,-14,133,-14,146,-14,137,-14,134,-14,139,-14,136,-14,131,-14,147,-14,145,-14,142,-14},new int[]{-4,136,-16,137,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    AddState(136,new State(new int[]{44,11,59,-15,127,-15,130,-15,138,-15,148,-15,133,-15,146,-15,137,-15,134,-15,139,-15,143,-15,136,-15,131,-15,147,-15,145,-15,142,-15}));
    AddState(137,new State(new int[]{42,13,47,15,37,17,43,19,45,21,94,23,154,25,60,27,62,29,151,31,150,33,152,35,153,37,156,39,155,41,44,-46,59,-46,127,-46,130,-46,138,-46,148,-46,133,-46,146,-46,137,-46,134,-46,139,-46,143,-46,136,-46,131,-46,147,-46,145,-46,142,-46,41,-46}));
    AddState(138,new State(-16));
    AddState(139,new State(new int[]{130,52},new int[]{-1,140}));
    AddState(140,new State(new int[]{61,141,44,151}));
    AddState(141,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-17,142,-16,57,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    AddState(142,new State(new int[]{44,143}));
    AddState(143,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-17,144,-16,57,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    AddState(144,new State(new int[]{44,149,138,-22},new int[]{-25,145}));
    AddState(145,new State(new int[]{138,146}));
    AddState(146,new State(-4,new int[]{-19,147,-18,66}));
    AddState(147,new State(new int[]{131,148}));
    AddState(148,new State(-17));
    AddState(149,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-17,150,-16,57,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    AddState(150,new State(-21));
    AddState(151,new State(new int[]{130,52},new int[]{-1,152}));
    AddState(152,new State(new int[]{132,153}));
    AddState(153,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-17,154,-16,57,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    AddState(154,new State(new int[]{138,155}));
    AddState(155,new State(-4,new int[]{-19,156,-18,66}));
    AddState(156,new State(new int[]{131,157}));
    AddState(157,new State(-18));
    AddState(158,new State(new int[]{130,52},new int[]{-11,159,-1,173}));
    AddState(159,new State(new int[]{40,160}));
    AddState(160,new State(new int[]{149,166,130,52,41,-24},new int[]{-12,161,-13,165,-1,167}));
    AddState(161,new State(new int[]{41,162}));
    AddState(162,new State(-4,new int[]{-19,163,-18,66}));
    AddState(163,new State(new int[]{131,164}));
    AddState(164,new State(-19));
    AddState(165,new State(-23));
    AddState(166,new State(-84));
    AddState(167,new State(-44,new int[]{-15,168}));
    AddState(168,new State(new int[]{44,170,41,-87},new int[]{-14,169}));
    AddState(169,new State(-85));
    AddState(170,new State(new int[]{149,172,130,52},new int[]{-1,171}));
    AddState(171,new State(-43));
    AddState(172,new State(-86));
    AddState(173,new State(new int[]{46,174,58,176,40,-31}));
    AddState(174,new State(new int[]{130,52},new int[]{-1,175}));
    AddState(175,new State(-32));
    AddState(176,new State(new int[]{130,52},new int[]{-1,177}));
    AddState(177,new State(-33));
    AddState(178,new State(new int[]{130,52},new int[]{-7,179,-1,184}));
    AddState(179,new State(new int[]{61,182,59,-26,127,-26,130,-26,138,-26,148,-26,133,-26,146,-26,137,-26,134,-26,139,-26,143,-26,136,-26,131,-26,147,-26,145,-26,142,-26},new int[]{-8,180,-9,181}));
    AddState(180,new State(-20));
    AddState(181,new State(-25));
    AddState(182,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101},new int[]{-4,183,-16,137,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    AddState(183,new State(new int[]{44,11,59,-45,127,-45,130,-45,138,-45,148,-45,133,-45,146,-45,137,-45,134,-45,139,-45,143,-45,136,-45,131,-45,147,-45,145,-45,142,-45}));
    AddState(184,new State(-44,new int[]{-15,185}));
    AddState(185,new State(new int[]{44,186,61,-42,59,-42,127,-42,130,-42,138,-42,148,-42,133,-42,146,-42,137,-42,134,-42,139,-42,143,-42,136,-42,131,-42,147,-42,145,-42,142,-42}));
    AddState(186,new State(new int[]{130,52},new int[]{-1,171}));
    AddState(187,new State(new int[]{130,52},new int[]{-1,188}));
    AddState(188,new State(-39));
    AddState(189,new State(-76));
    AddState(190,new State(new int[]{130,52},new int[]{-1,191}));
    AddState(191,new State(new int[]{40,193,123,85,128,198},new int[]{-22,192,-28,197}));
    AddState(192,new State(-77));
    AddState(193,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,94,157,97,35,99,158,101,41,-82},new int[]{-23,194,-4,196,-16,137,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-40,81,-28,84}));
    AddState(194,new State(new int[]{41,195}));
    AddState(195,new State(-78));
    AddState(196,new State(new int[]{44,11,41,-81}));
    AddState(197,new State(-79));
    AddState(198,new State(-80));

    Rule[] rules=new Rule[110];
    rules[1]=new Rule(-38, new int[]{-37,127});
    rules[2]=new Rule(-37, new int[]{-18,127});
    rules[3]=new Rule(-18, new int[]{-18,-6,-39});
    rules[4]=new Rule(-18, new int[]{});
    rules[5]=new Rule(-39, new int[]{59});
    rules[6]=new Rule(-39, new int[]{});
    rules[7]=new Rule(-19, new int[]{-18});
    rules[8]=new Rule(-6, new int[]{-3,61,-4});
    rules[9]=new Rule(-6, new int[]{-20});
    rules[10]=new Rule(-6, new int[]{138,-19,131});
    rules[11]=new Rule(-6, new int[]{148,-17,138,-19,131});
    rules[12]=new Rule(-6, new int[]{133,-19,147,-17});
    rules[13]=new Rule(-6, new int[]{146,-17,141,-19,-26,-27,131});
    rules[14]=new Rule(-6, new int[]{137});
    rules[15]=new Rule(-6, new int[]{137,-4});
    rules[16]=new Rule(-6, new int[]{134});
    rules[17]=new Rule(-6, new int[]{139,-1,61,-17,44,-17,-25,138,-19,131});
    rules[18]=new Rule(-6, new int[]{139,-1,44,-1,132,-17,138,-19,131});
    rules[19]=new Rule(-6, new int[]{143,-11,40,-12,41,-19,131});
    rules[20]=new Rule(-6, new int[]{136,-7,-8});
    ...
    rules[27]=new Rule(-26, new int[]{-26,145,-17,141,-19});
    rules[28]=new Rule(-26, new int[]{});
    rules[29]=new Rule(-27, new int[]{142,-19});
    ...
    rules[49]=new Rule(-16, new int[]{140});
    ...
    rules[54]=new Rule(-16, new int[]{-40});
    ...
    rules[64]=new Rule(-16, new int[]{-16,154,-16});
    rules[65]=new Rule(-16, new int[]{-16,60,-16});
    rules[66]=new Rule(-16, new int[]{-16,62,-16});
    rules[67]=new Rule(-16, new int[]{-16,151,-16});
    rules[68]=new Rule(-16, new int[]{-16,150,-16});
    rules[69]=new Rule(-16, new int[]{-16,152,-16});
    rules[70]=new Rule(-16, new int[]{-16,153,-16});
    rules[71]=new Rule(-16, new int[]{-16,156,-16});
    rules[72]=new Rule(-16, new int[]{-16,155,-16});
    rules[73]=new Rule(-16, new int[]{157,-16});
    rules[74]=new Rule(-16, new int[]{35,-16});
    rules[75]=new Rule(-16, new int[]{158,-16});
    rules[76]=new Rule(-20, new int[]{-21,-22});
    rules[77]=new Rule(-20, new int[]{-21,58,-1,-22});
    rules[78]=new Rule(-22, new int[]{40,-23,41});
    rules[79]=new Rule(-22, new int[]{-28});
    rules[80]=new Rule(-22, new int[]{128});
    rules[81]=new Rule(-23, new int[]{-4});
    rules[82]=new Rule(-23, new int[]{});
    rules[83]=new Rule(-24, new int[]{143,40,-12,41,-19,131});
    rules[84]=new Rule(-13, new int[]{149});
    rules[85]=new Rule(-13, new int[]{-1,-15,-14});
    rules[86]=new Rule(-14, new int[]{44,149});
    rules[87]=new Rule(-14, new int[]{});
    rules[88]=new Rule(-40, new int[]{37,-1});
    rules[89]=new Rule(-28, new int[]{123,-29,125});
    rules[90]=new Rule(-29, new int[]{-30});
    rules[91]=new Rule(-29, new int[]{-33});
    rules[92]=new Rule(-30, new int[]{-31});
    rules[93]=new Rule(-30, new int[]{});
    rules[94]=new Rule(-33, new int[]{-34});
    rules[95]=new Rule(-33, new int[]{});
    rules[96]=new Rule(-31, new int[]{-16,-32,44});
    rules[97]=new Rule(-31, new int[]{-16,-32});
    rules[98]=new Rule(-34, new int[]{-36,-35,44});
    rules[99]=new Rule(-34, new int[]{-36,-35});
    rules[100]=new Rule(-32, new int[]{-32,44,-16});
    rules[101]=new Rule(-32, new int[]{});
    rules[102]=new Rule(-35, new int[]{-35,44,-36});
    rules[103]=new Rule(-35, new int[]{});
    rules[104]=new Rule(-36, new int[]{91,-16,93,61,-16});
    rules[105]=new Rule(-36, new int[]{-1,61,-16});
    rules[106]=new Rule(-1, new int[]{130});
    rules[107]=new Rule(-2, new int[]{-2,129});
    rules[108]=new Rule(-2, new int[]{-2,46,129});
    rules[109]=new Rule(-2, new int[]{129});
    ...
    this.InitNonTerminals(new string[] {"", "NAME", "NUMBER", "VARLIST1", "EXPLIST1", 
      ...
      "LST", "FFIELDLIST", "FFIELDLIST1", "FST", "FFIELD", "PROGRAM", "$accept", 
      "COMMA", "UPVALUE", });
  }
...
{CurrentSemanticValue.TN = m_tree.CreateNode(ASTree.FUNCNAME, ValueStack[ValueStack.Depth-1].s);}
        break;
      case 32: // FUNCNAME -> NAME, '.', NAME
{/*$$ = m_tree.CreateNode(ASTree.FUNCNAME, $1, $3);*/}
        break;
...
{CurrentSemanticValue.TN = m_tree.CreateNode(ASTree.OperatorConcatenacii, ValueStack[ValueStack.Depth-3].TN, ValueStack[ValueStack.Depth-1].TN);}
        break;
      case 76: // FUNCTION_CALL -> VARORFUNC, ARGS
