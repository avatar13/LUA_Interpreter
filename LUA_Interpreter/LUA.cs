...
#pragma warning restore 649
  ...
  protected override void Initialize()
  {
    ...
    AddState(0,new State(-4,new int[]{-34,1,-18,3}));
    AddState(1,new State(new int[]{127,2}));
    AddState(2,new State(-1));
    AddState(3,new State(new int[]{127,4,130,52,138,73,148,76,133,122,146,126,137,139,134,142,139,143,143,162,136,182},new int[]{-6,5,-3,8,-5,67,-1,51,-21,53,-20,72}));
    AddState(4,new State(-2));
    AddState(5,new State(new int[]{59,7,127,-6,130,-6,138,-6,148,-6,133,-6,146,-6,137,-6,134,-6,139,-6,143,-6,136,-6,131,-6,147,-6,145,-6,142,-6},new int[]{-36,6}));
    AddState(6,new State(-3));
    AddState(7,new State(-5));
    AddState(8,new State(new int[]{61,9}));
    AddState(9,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-4,10,-16,141,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(11,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,12,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(13,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,14,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(15,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,16,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(17,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,18,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(19,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,20,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(21,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,22,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(23,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,24,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    AddState(24,new State(-63));
    AddState(25,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,26,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(27,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,28,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(29,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,30,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(31,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,32,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(33,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,34,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(35,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,36,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(37,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,38,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(39,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,40,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(41,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,42,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(53,new State(new int[]{91,54,46,191,58,194,40,197,123,85,128,202},new int[]{-22,193,-28,201}));
    AddState(54,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-17,55,-16,57,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(61,new State(new int[]{149,170,130,52,41,-24},new int[]{-12,62,-13,169,-1,171}));
    ...
    AddState(66,new State(new int[]{130,52,138,73,148,76,133,122,146,126,137,139,134,142,139,143,143,162,136,182,131,-7,147,-7,145,-7,142,-7},new int[]{-6,5,-3,8,-5,67,-1,51,-21,53,-20,72}));
    ...
    AddState(76,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-17,77,-16,57,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(85,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108,91,96,59,-95,125,-95},new int[]{-29,86,-30,88,-31,113,-16,114,-2,44,-5,50,-1,118,-21,53,-20,58,-24,59,-37,81,-28,84,-33,119,-38,91,-39,92}));
    AddState(86,new State(new int[]{125,87}));
    AddState(87,new State(-89));
    AddState(88,new State(new int[]{59,89,125,-90}));
    AddState(89,new State(new int[]{91,96,130,52,125,-97},new int[]{-33,90,-38,91,-39,92,-1,110}));
    ...
    AddState(96,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,97,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(99,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,100,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(101,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,102,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(104,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,105,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    AddState(105,new State(-73));
    AddState(106,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,107,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    AddState(107,new State(-74));
    AddState(108,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,109,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    AddState(109,new State(-75));
    AddState(110,new State(new int[]{61,111}));
    AddState(111,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-16,112,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(114,new State(new int[]{42,13,47,15,37,17,43,19,45,21,94,23,154,25,60,27,62,29,151,31,150,33,152,35,153,37,156,39,155,41,44,-103,59,-103,125,-103},new int[]{-32,115}));
    AddState(115,new State(new int[]{44,116,59,-99,125,-99}));
    AddState(116,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108,59,-98,125,-98},new int[]{-16,117,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(120,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108,125,-95},new int[]{-30,121,-31,113,-16,114,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    AddState(121,new State(-93));
    AddState(122,new State(-4,new int[]{-19,123,-18,66}));
    AddState(123,new State(new int[]{147,124}));
    AddState(124,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-17,125,-16,57,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    AddState(125,new State(-12));
    AddState(126,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-17,127,-16,57,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    AddState(127,new State(new int[]{141,128}));
    AddState(128,new State(-4,new int[]{-19,129,-18,66}));
    AddState(129,new State(-28,new int[]{-26,130}));
    AddState(130,new State(new int[]{145,133,142,137,131,-30},new int[]{-27,131}));
    AddState(131,new State(new int[]{131,132}));
    AddState(132,new State(-13));
    AddState(133,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-17,134,-16,57,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    AddState(134,new State(new int[]{141,135}));
    AddState(135,new State(-4,new int[]{-19,136,-18,66}));
    AddState(136,new State(-27));
    AddState(137,new State(-4,new int[]{-19,138,-18,66}));
    AddState(138,new State(-29));
    AddState(139,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108,59,-14,127,-14,138,-14,148,-14,133,-14,146,-14,137,-14,134,-14,139,-14,136,-14,131,-14,147,-14,145,-14,142,-14},new int[]{-4,140,-16,141,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(145,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-17,146,-16,57,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    AddState(146,new State(new int[]{44,147}));
    AddState(147,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-17,148,-16,57,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    AddState(148,new State(new int[]{44,153,138,-22},new int[]{-25,149}));
    AddState(149,new State(new int[]{138,150}));
    AddState(150,new State(-4,new int[]{-19,151,-18,66}));
    AddState(151,new State(new int[]{131,152}));
    AddState(152,new State(-17));
    AddState(153,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-17,154,-16,57,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    AddState(154,new State(-21));
    AddState(155,new State(new int[]{130,52},new int[]{-1,156}));
    AddState(156,new State(new int[]{132,157}));
    AddState(157,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-17,158,-16,57,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    AddState(158,new State(new int[]{138,159}));
    AddState(159,new State(-4,new int[]{-19,160,-18,66}));
    AddState(160,new State(new int[]{131,161}));
    AddState(161,new State(-18));
    AddState(162,new State(new int[]{130,52},new int[]{-11,163,-1,177}));
    AddState(163,new State(new int[]{40,164}));
    AddState(164,new State(new int[]{149,170,130,52,41,-24},new int[]{-12,165,-13,169,-1,171}));
    AddState(165,new State(new int[]{41,166}));
    AddState(166,new State(-4,new int[]{-19,167,-18,66}));
    AddState(167,new State(new int[]{131,168}));
    AddState(168,new State(-19));
    AddState(169,new State(-23));
    AddState(170,new State(-84));
    AddState(171,new State(-44,new int[]{-15,172}));
    AddState(172,new State(new int[]{44,174,41,-87},new int[]{-14,173}));
    ...
    AddState(182,new State(new int[]{130,52},new int[]{-7,183,-1,188}));
    AddState(183,new State(new int[]{61,186,59,-26,127,-26,130,-26,138,-26,148,-26,133,-26,146,-26,137,-26,134,-26,139,-26,143,-26,136,-26,131,-26,147,-26,145,-26,142,-26},new int[]{-8,184,-9,185}));
    AddState(184,new State(-20));
    AddState(185,new State(-25));
    AddState(186,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108},new int[]{-4,187,-16,141,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    AddState(188,new State(-44,new int[]{-15,189}));
    ...
    AddState(195,new State(new int[]{40,197,123,85,128,202},new int[]{-22,196,-28,201}));
    AddState(196,new State(-77));
    AddState(197,new State(new int[]{140,43,129,48,128,49,130,52,143,60,37,82,123,85,40,101,157,104,35,106,158,108,41,-82},new int[]{-23,198,-4,200,-16,141,-2,44,-5,50,-1,51,-21,53,-20,58,-24,59,-37,81,-28,84}));
    ...
    rules[1]=new Rule(-35, new int[]{-34,127});
    rules[2]=new Rule(-34, new int[]{-18,127});
    rules[3]=new Rule(-18, new int[]{-18,-6,-36});
    rules[4]=new Rule(-18, new int[]{});
    rules[5]=new Rule(-36, new int[]{59});
    rules[6]=new Rule(-36, new int[]{});
    ...
    rules[92]=new Rule(-29, new int[]{-30,59,-33});
    rules[93]=new Rule(-29, new int[]{-33,59,-30});
    rules[94]=new Rule(-30, new int[]{-31});
    rules[95]=new Rule(-30, new int[]{});
    rules[96]=new Rule(-33, new int[]{-38});
    rules[97]=new Rule(-33, new int[]{});
    rules[98]=new Rule(-31, new int[]{-16,-32,44});
    rules[99]=new Rule(-31, new int[]{-16,-32});
    rules[100]=new Rule(-38, new int[]{-39,-40,44});
    rules[101]=new Rule(-38, new int[]{-39,-40});
    rules[102]=new Rule(-32, new int[]{-32,44,-16});
    rules[103]=new Rule(-32, new int[]{});
    rules[104]=new Rule(-40, new int[]{-40,44,-39});
    rules[105]=new Rule(-40, new int[]{});
    rules[106]=new Rule(-39, new int[]{91,-16,93,61,-16});
    rules[107]=new Rule(-39, new int[]{-1,61,-16});
    ...
    this.InitNonTerminals(new string[] {"", "NAME", "NUMBER", "VARLIST1", "EXPLIST1", 
      ...
      "LST", "FFIELDLIST", "PROGRAM", "$accept", "COMMA", "UPVALUE", "FFIELDLIST1", 
      "FFIELD", "FST", });
  }
